        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/resume-builder" className="text-sm text-gray-500 hover:text-gray-900 transition-colors">
                  Create Resume
                </Link>
              </li>
              <li>
                <Link to="/my-resumes" className="text-sm text-gray-500 hover:text-gray-900 transition-colors">
                  My Resumes
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mb-4">
              Get the latest updates about new templates and features.
            </p>
            <div className="flex">
              <input
                type="email"
              ...
              />
              <button className="px-4 py-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white text-sm font-medium rounded-r-lg hover:from-blue-700 hover:to-purple-700 transition-all">
                Subscribe
              </button>
            </div>
          </div>
        ...
        <div className="pt-8 border-t border-gray-200">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            <p className="text-sm text-gray-500">
              &copy; {currentYear} Hobu. All rights reserved.
            </p>
